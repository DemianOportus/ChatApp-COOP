      ...
      <div className="div--promos mt-10">
          ...
          <div className="mt-4">
            <div className="mt-4">
              <ol className="text-2xl">
                <li className="pt-[15px]"><a className="underline">{i18n.gettext("li1")}</a></li>
        ...
        <div>
          <div className="flex justify-between">
            <h1 className="uppercase text-4xl p-[20px]">what makes this solution different</h1>
            <button 
              className="px-[20px]"
              onClick={toggleWhatMakesItDifferent}><i class="fa-solid fa-angle-down"></i></button>
          </div>
        ...
        <div>
          <div className="flex justify-between">
            <h1 className="uppercase text-4xl p-[20px]">how to use this solution in your practice</h1>
            <button 
              className="p-[20px]"
              onClick={toggleHowToUse}><i class="fa-solid fa-angle-down"></i></button>
          </div>
        ...
        <div>
          <div className="flex justify-between">
            <h1 className="uppercase text-4xl px-[20px]">incentives for onboarding new patients</h1>
            <button 
              className="px-[20px]"
              onClick={toggleIncentives}><i class="fa-solid fa-angle-down"></i></button>
          </div>
