...
const fr = {
  ...
  language: "English",
  joinPatient: "Joindre en tant que patient",
  joinDoctor: "Joindre en tant que docteur",
  textSizeIncrease: "Taille du texte +",
  textSizeDecrease: "Taille du texte -",
  clinicOfTheFuture: "Clinique du futur",
  home: "Accueil",
  forPatients: "Pour patients",
  ...
  ul5: "Pas de correspondance? Vous serez placé dans une file d'attente et recevrez des mises à jour de statut mensuelles (jusqu'à 6 mois, désabonnez-vous à tout moment)",
